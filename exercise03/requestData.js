 ...
 */
 ...
 function showData(weatherDataJSON) {
     ...
     let htmlText = generateHTMLString(weatherDataJSON);
...
function generateHTMLString(weatherDataJSON) {
    let htmlText;
 ...
 /**
  * Generating a link for requesting a time object, from a unix time stamp. Using these API: https://unixtime.co.za/
