...
function addTileLayer(mapObj) {
    L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=' + mapBoxKey, osmTileLayerOptions).addTo(mapObj);
}
...
function setMarkersToIntersections(e) {
    clearAllMarkers();
    let intersects = calculateIntersections(e);
